    ...
    <div class="container">
      <div class="policy">
        ...
        <p>
          ...
          данных и меры по обеспечению безопасности персональных данных ООО «СК
          Сервис» (далее – Оператор).
        </p>
        <ul>
          <li>
          ...
          <li>
            ...
            Оператор может получить о посетителях веб-сайта http://mysite.ru.
          </li>
        </ul>
        ...
        <ul>
          ...
          <li>
            ...
            в сети интернет по сетевому адресу http://mysite.ru;
          </li>
          <li>
          ...
          <li>
            9. Пользователь – любой посетитель веб-сайта http://mysite.ru;
          </li>
          <li>
        ...
        <ul>
          ...
          <li>
            ...
            поситителях (в т.ч файлов "cookie") с помощью сервисов интернет
            статистики (Яндекс Метрика, Гугл Аналитика и других)
          </li>
          <li>
            5. Вышеперечисленные дынные далее по тексту Политики объеденины
        ...
        <ul>
          ...
          <li>
            ...
            электронной почты 711347@mail.ru с пометкой «Отказ от уведомлениях о
        ...
        <ul>
          <li>
            ...
            через специальные формы, расположенные на сайте http://mysite.ru.
        ...
        <ul>
          ...
          <li>
            ...
            Оператора 711347@mail.ru с пометкой «Актуализация персональных
            данных».
          </li>
          <li>
            ...
            Оператора711347@mail.ru с пометкой «Отзыв согласия на обработку
            персональных данных».
          </li>
        </ul>
        ...
        <ul>
          <li>
            ...
            к Оператору с помощью электронной почты 711347@mail.ru.
          </li>
          <li>
          ...
          <li>
            ...
            Интернет по адресу http://mysite.ru/policy.
          </li>
        </ul>
      </div>
    </div>
